    ...
    return (
        <section>
            ...
            <div className={styles.textos}>
                ...
                <h2 className={styles.textoComum}>É importante lembrar que apenas os equipamentos acima podem ser utilizados no campo adicionar equipamento, segue abaixo a lista deles:</h2>
                ...
                <h2 className={styles.textoComum}>É possível também <strong className={styles.textoMarcado}>Excluir</strong> e <strong className={styles.textoMarcado}>Editar</strong> equipamentos através dos botões de cada equipamento, caso seja necessário.</h2>
            </div>
            <div className={styles.textos}>
                ...
                <h2 className={styles.textoComum}>Além disso também é possível <strong className={styles.textoMarcado}>Excluir</strong> um patrimônio no card do próprio patrimônio. Não existe botão de editar patrimônio, caso o mesmo não esteja correto, será necessário excluí-lo e cadastrar um novo.</h2>
